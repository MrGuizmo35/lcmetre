...
// get/set D5 aliases
#define D5_TRIS               TRISBbits.TRISB4
#define D5_LAT                LATBbits.LATB4
#define D5_PORT               PORTBbits.RB4
#define D5_WPU                WPUBbits.WPUB4
#define D5_OD                ODCONBbits.ODB4
#define D5_ANS                ANSELBbits.ANSB4
#define D5_SetHigh()            do { LATBbits.LATB4 = 1; } while(0)
#define D5_SetLow()             do { LATBbits.LATB4 = 0; } while(0)
#define D5_Toggle()             do { LATBbits.LATB4 = ~LATBbits.LATB4; } while(0)
#define D5_GetValue()           PORTBbits.RB4
#define D5_SetDigitalInput()    do { TRISBbits.TRISB4 = 1; } while(0)
#define D5_SetDigitalOutput()   do { TRISBbits.TRISB4 = 0; } while(0)
#define D5_SetPullup()      do { WPUBbits.WPUB4 = 1; } while(0)
#define D5_ResetPullup()    do { WPUBbits.WPUB4 = 0; } while(0)
#define D5_SetPushPull()    do { ODCONBbits.ODB4 = 1; } while(0)
#define D5_SetOpenDrain()   do { ODCONBbits.ODB4 = 0; } while(0)
#define D5_SetAnalogMode()  do { ANSELBbits.ANSB4 = 1; } while(0)
#define D5_SetDigitalMode() do { ANSELBbits.ANSB4 = 0; } while(0)

// get/set D4 aliases
#define D4_TRIS               TRISBbits.TRISB5
#define D4_LAT                LATBbits.LATB5
#define D4_PORT               PORTBbits.RB5
#define D4_WPU                WPUBbits.WPUB5
#define D4_OD                ODCONBbits.ODB5
#define D4_ANS                ANSELBbits.ANSB5
#define D4_SetHigh()            do { LATBbits.LATB5 = 1; } while(0)
#define D4_SetLow()             do { LATBbits.LATB5 = 0; } while(0)
#define D4_Toggle()             do { LATBbits.LATB5 = ~LATBbits.LATB5; } while(0)
#define D4_GetValue()           PORTBbits.RB5
#define D4_SetDigitalInput()    do { TRISBbits.TRISB5 = 1; } while(0)
#define D4_SetDigitalOutput()   do { TRISBbits.TRISB5 = 0; } while(0)
#define D4_SetPullup()      do { WPUBbits.WPUB5 = 1; } while(0)
#define D4_ResetPullup()    do { WPUBbits.WPUB5 = 0; } while(0)
#define D4_SetPushPull()    do { ODCONBbits.ODB5 = 1; } while(0)
#define D4_SetOpenDrain()   do { ODCONBbits.ODB5 = 0; } while(0)
#define D4_SetAnalogMode()  do { ANSELBbits.ANSB5 = 1; } while(0)
#define D4_SetDigitalMode() do { ANSELBbits.ANSB5 = 0; } while(0)
...
#define EN_SetPushPull()    do { ODCONBbits.ODB6 = 1; } while(0)
#define EN_SetOpenDrain()   do { ODCONBbits.ODB6 = 0; } while(0)
...
#define RS_SetPushPull()    do { ODCONBbits.ODB7 = 1; } while(0)
#define RS_SetOpenDrain()   do { ODCONBbits.ODB7 = 0; } while(0)
...
#define D7_SetPushPull()    do { ODCONCbits.ODC1 = 1; } while(0)
#define D7_SetOpenDrain()   do { ODCONCbits.ODC1 = 0; } while(0)
...
#define D6_SetPushPull()    do { ODCONCbits.ODC2 = 1; } while(0)
#define D6_SetOpenDrain()   do { ODCONCbits.ODC2 = 0; } while(0)
...
#define IND_OUT_TRIS               TRISCbits.TRISC5
#define IND_OUT_LAT                LATCbits.LATC5
#define IND_OUT_PORT               PORTCbits.RC5
#define IND_OUT_WPU                WPUCbits.WPUC5
#define IND_OUT_OD                ODCONCbits.ODC5
#define IND_OUT_SetHigh()            do { LATCbits.LATC5 = 1; } while(0)
#define IND_OUT_SetLow()             do { LATCbits.LATC5 = 0; } while(0)
#define IND_OUT_Toggle()             do { LATCbits.LATC5 = ~LATCbits.LATC5; } while(0)
#define IND_OUT_GetValue()           PORTCbits.RC5
#define IND_OUT_SetDigitalInput()    do { TRISCbits.TRISC5 = 1; } while(0)
#define IND_OUT_SetDigitalOutput()   do { TRISCbits.TRISC5 = 0; } while(0)
#define IND_OUT_SetPullup()      do { WPUCbits.WPUC5 = 1; } while(0)
#define IND_OUT_ResetPullup()    do { WPUCbits.WPUC5 = 0; } while(0)
#define IND_OUT_SetPushPull()    do { ODCONCbits.ODC5 = 1; } while(0)
#define IND_OUT_SetOpenDrain()   do { ODCONCbits.ODC5 = 0; } while(0)
